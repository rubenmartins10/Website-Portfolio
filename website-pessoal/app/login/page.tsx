      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-white/[0.08] bg-white/[0.025] p-8">
          ...
          <p className="text-zinc-500 text-sm mb-8">
            Esta área é exclusiva para o administrador do website.
          </p>
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl bg-white text-zinc-950 font-semibold text-sm hover:bg-zinc-100 transition-colors"
            >
