...
const SOCIALS = [
  ...
  },
  {
    label: 'GitHub',
    value: 'github.com/\nrubenmartins10',
    href: 'https://github.com/rubenmartins10',
    color: 'bg-zinc-600/25 text-zinc-300',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
  ...
  {
    label: 'Instagram',
    value: '@rubenmartins10',
    href: 'https://instagram.com/rubenmartins10',
    ...
    <footer className="w-full border-t border-white/[0.06] mt-24 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="text-center mb-14">
          <div className="font-mono text-xs text-emerald-400 tracking-[0.3em] uppercase mb-3">CONTACT</div>
          <h2 className="font-mono font-black text-white text-3xl md:text-5xl uppercase tracking-widest mb-4">
            LET&apos;S CONNECT
          </h2>
          <div className="w-12 h-0.5 bg-emerald-400 mx-auto mb-4" />
          <p className="text-zinc-500 text-sm">Open to opportunities in Web Development, AI &amp; Data Engineering</p>
        </div>

        {/* Social Cards */}
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 mb-8">
          {SOCIALS.map(({ label, value, href, color, icon }) => (
            <a
              key={label}
              href={href}
            ...
            >
              ...
              <span className="font-mono text-[10px] text-zinc-500 leading-snug whitespace-pre-line">{value}</span>
            </a>
          ))}
        </div>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-white/[0.05] mt-10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-3">
