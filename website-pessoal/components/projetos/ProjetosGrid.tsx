                ...
                <div>
                  ...
                  {projeto.tecnologias?.length > 0 && (
                    <div className="flex flex-wrap gap-1.5 mb-6">
                      {projeto.tecnologias.map((tech) => (
                        <span
                          key={tech}
                          className="font-mono text-[10px] text-zinc-300 border border-zinc-600/50 bg-zinc-800/50 px-3 py-1 rounded-full tracking-wide hover:border-cyan-400/40 hover:text-cyan-300 transition-colors"
                        >
                          {tech}
                        </span>
                      ))}
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <button
                      ...
                      className="font-mono text-xs text-zinc-300 border border-zinc-600/50 hover:border-cyan-400/40 hover:text-cyan-300 px-6 py-2.5 rounded-full tracking-widest uppercase transition-colors flex items-center gap-2"
                    >
                      Details →
                    </button>
                  </div>
